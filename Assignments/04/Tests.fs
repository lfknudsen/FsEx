...
let ``BoolExprToString1`` () =
    ...
    Assert.Equal("(not ((not (42 < (32 + 10))) /\ (not (not (32 < (27 + (((27 / 25) * 25) * -1)))))))",
...
let AExprEval2 () =
    ...
    Assert.Equal( aexprEval (Num 42 .*. (Num 13 .%. Num 3)), aexprEval2 (Num 42 .*. (Num 13 .%. Num 3)) )
    Assert.Equal( aexprEval (Num 42 .*. (Num 13 .%. Num 0)), aexprEval2 (Num 42 .*. (Num 13 .%. Num 0)) )
...
let AExprEval3 () =
    ...
    Assert.Equal( aexprEval (Num 42 .*. (Num 13 .%. Num 3)), aexprEval3 (Num 42 .*. (Num 13 .%. Num 3)) )
    Assert.Equal( aexprEval (Num 42 .*. (Num 13 .%. Num 0)), aexprEval3 (Num 42 .*. (Num 13 .%. Num 0)) )
...
let ``ArithExprToString4`` () =
    ...
    Assert.Equal("18 / (3 / 2)", aexprToString4 (Num 18 ./. (Num 3 ./. Num 2)) )
    Assert.Equal("42 * (13 + 13 / 3 * 3 * -1)",
                 aexprToString4 (Num 42 .*. (Num 13 .%. Num 3)) )
...
let ``BexprFold`` () =
    ...
    Assert.Throws<DivideByZeroException>(fun () -> simpleBEval (Num 4 .>. Num 32 .%. Num 0) |> ignore)
...
let BoolExprEval1 () =
    ...
    Assert.Equal(Some true,  bexprEval ((Num 42 .<. Num 32 .+. Num 10) .||. (Num 32 .>=. Num 27 .%. Num 25)))
...
let BoolExprEval2 () =
    ...
    Assert.Equal(Some true,  bexprEval3 ((Num 42 .<. Num 32 .+. Num 10) .||. (Num 32 .>=. Num 27 .%. Num 25)))
